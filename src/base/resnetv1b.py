...
__all__ = ['ResNetV1b', 'resnet18_v1b', 'resnet34_v1b', 'resnet50_v1b', 'resnet101_v1b', 'resnet152_v1b', 'resnet152_v1s', 'resnet101_v1s', 'resnet50_v1s']
...
class ResNetV1b(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, dilated=True, deep_stem=False,
                 zero_init_residual=False, norm_layer=nn.BatchNorm2d, in_channel=3):
...
def resnet50_v1s(pretrained=False, root='~/.torch/models', **kwargs):
    ...
    if pretrained:
        from model.base_models.model_store import get_resnet_file
